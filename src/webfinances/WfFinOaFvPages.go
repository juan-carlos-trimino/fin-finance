...
func (o WfOaFvPages) OaFvPages(res http.ResponseWriter, req *http.Request) {
  ...
  ***/
  ...
  templatesNeeded := []string{
    ...
    "webfinances/templates/finances/ordinaryannuity/fv/" + partialTemplate,
  ...
  if err != nil {
    ...
    go func(userData []byte, uName, cId string) {
      filePath := fmt.Sprintf("%s/%s/oafv.txt", mainDir, uName)
...
func (o WfOaFvPages) processUi1Form(req *http.Request, fields *oaFvFields, correlationId string) {
...
func (o WfOaFvPages) processUi2Form(req *http.Request, fields *oaFvFields, correlationId string) {
