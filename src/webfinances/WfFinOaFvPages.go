    ...
    if strings.EqualFold(currentRHS, "rhs-ui1") {
      ...
      if req.Method == http.MethodPost {
        ...
        if n, err = strconv.ParseFloat(of.Fd1N, 64); err != nil {
          ...
          of.Fd1Result = fmt.Sprintf("Future Value: $%.5f",
            oa.O_FutureValue_PV(fv, i / 100.0, oa.GetCompoundingPeriod(of.Fd1Compound[0], true), n,
      ...
      renderer.Render(res, "layout", templatesNeeded, renderer.PageData{
        Data: struct{
          ...
          Fd1FV string
          Fd1Result string
        } { "Ordinary Annuity / Future Value", logger.DatetimeFormat(), financesMenuPage, of.CurrentButton,
      ...
      if req.Method == http.MethodPost {
        ...
        if n, err = strconv.ParseFloat(of.Fd2N, 64); err != nil {
          ...
          var oa finances.Annuities
          of.Fd2Result = fmt.Sprintf("Future Value: $%.5f", oa.O_FutureValue_PMT(pmt, i / 100.0,
      ...
      renderer.Render(res, "layout", templatesNeeded, renderer.PageData{
        Data: struct{
          ...
          Fd2Result string
            ...
            newSession.CsrfToken, of.Fd2N, of.Fd2TimePeriod, of.Fd2Interest, of.Fd2Compound, of.Fd2PMT, of.Fd2Result },
      })
    } else {
