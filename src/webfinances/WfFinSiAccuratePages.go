  ...
  ***/
  ...
  case "rhs-ui1":
    ...
    templateData = struct{
      ...
      "standard",
      "Simple Interest / Accurate (Exact) Interest",
  ...
  templatesNeeded := []string{
    ...
    "webfinances/templates/finances/simpleinterestaccurate/" + partialTemplate,
  ...
  if err != nil {
    ...
    go func(userData []byte, uName, cId string) {
      filePath := fmt.Sprintf("%s/%s/siaccurate.txt", mainDir, uName)
...
func (s WfSiAccuratePages) processUi1Form(req *http.Request, fields *siAccurateFields, correlationId string) {
...
func (s WfSiAccuratePages) processUi2Form(req *http.Request, fields *siAccurateFields, correlationId string) {
...
func (s WfSiAccuratePages) processUi3Form(req *http.Request, fields *siAccurateFields, correlationId string) {
...
func (s WfSiAccuratePages) processUi4Form(req *http.Request, fields *siAccurateFields, correlationId string) {
