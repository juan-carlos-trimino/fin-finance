  ...
  ***/
  ...
  case "rhs-ui1":
    ...
    templateData = struct{
      ...
      "standard",
      "Simple Interest / Ordinary Interest",
  ...
  templatesNeeded := []string{
    ...
    "webfinances/templates/finances/simpleinterestordinary/" + partialTemplate,
...
func (s WfSiOrdinaryPages) processUi1Form(req *http.Request, fields *siOrdinaryFields, correlationId string) {
...
func (s WfSiOrdinaryPages) processUi2Form(req *http.Request, fields *siOrdinaryFields, correlationId string) {
...
func (s WfSiOrdinaryPages) processUi3Form(req *http.Request, fields *siOrdinaryFields, correlationId string) {
...
func (s WfSiOrdinaryPages) processUi4Form(req *http.Request, fields *siOrdinaryFields, correlationId string) {
