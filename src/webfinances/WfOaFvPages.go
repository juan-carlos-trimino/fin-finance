...
type WfOaFvPages interface {
  OaFvPages(http.ResponseWriter, *http.Request)
}
...
func NewWfOaFvPages() WfOaFvPages {
  return &wfOaFvPages {
    currentPage: "rhs-ui1",
      ...
      ***/
      ...
      if req.Method == http.MethodPost {
        ...
        if n, err = strconv.ParseFloat(p.fd2N, 64); err != nil {
          ...
          var oa finances.Annuities
          p.fd2Result = fmt.Sprintf("Future Value: $%.2f", oa.O_FutureValue_PMT(pmt, i / 100.0,
