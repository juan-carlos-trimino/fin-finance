  ...
  ***/
  ...
  case "rhs-ui1":
    ...
    templateData = struct{
      ...
      "standard",
      "Ordinary Annuity / Equal Periodic Payments",
  ...
  templatesNeeded := []string{
    ...
    "webfinances/templates/finances/ordinaryannuity/epp/" + partialTemplate,
  ...
  if err != nil {
    ...
    go func(userData []byte, uName, cId string) {
      filePath := fmt.Sprintf("%s/%s/oaepp.txt", mainDir, uName)
...
func (o WfOaEppPages) processUi1Form(req *http.Request, fields *oaEppFields, correlationId string) {
...
func (o WfOaEppPages) processUi2Form(req *http.Request, fields *oaEppFields, correlationId string) {
