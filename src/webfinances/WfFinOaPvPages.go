...
func newOaPvFields(dir1, dir2, correlationId string) *oaPvFields {
  ...
  return loadFieldsFromDisk(dir1, dir2, "oapv.txt", correlationId, &defaults)
}

func getOaPvFields(userName string) *oaPvFields {
  return getFieldsGeneric(userName, func(s *UserSession) *oaPvFields {
    return s.Fields.oaPv
  })
}
...
func (o WfOaPvPages) OaPvPages(res http.ResponseWriter, req *http.Request) {
  ...
  ***/
  ...
  templatesNeeded := []string{
    ...
    "webfinances/templates/finances/ordinaryannuity/pv/" + partialTemplate,
  ...
  if err != nil {
    ...
    go func(userData []byte, uName, cId string) {
      filePath := fmt.Sprintf("%s/%s/oapv.txt", mainDir, uName)
...
func (o WfOaPvPages) processUi1Form(req *http.Request, fields *oaPvFields, correlationId string) {
...
func (o WfOaPvPages) processUi2Form(req *http.Request, fields *oaPvFields, correlationId string) {
