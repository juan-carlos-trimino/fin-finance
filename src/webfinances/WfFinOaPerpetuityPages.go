...
func (o WfOaPerpetuityPages) OaPerpetuityPages(res http.ResponseWriter, req *http.Request) {
  ...
  ***/
  ...
  templatesNeeded := []string{
    ...
    "webfinances/templates/finances/ordinaryannuity/perpetuity/" + partialTemplate,
...
func (o WfOaPerpetuityPages) processUi1Form(req *http.Request, fields *oaPerpetuityFields, correlationId string) {
...
func (o WfOaPerpetuityPages) processUi2Form(req *http.Request, fields *oaPerpetuityFields, correlationId string) {
